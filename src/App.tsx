...
const sampleData = [
  {
    ...
    description:
      "Learn the fundamentals of JavaScript programming language, including variables, functions, and objects.",
  },
  {
    title: "React Hooks Tutorial",
    url: "https://example.com/react-hooks",
    description:
      "A comprehensive guide to using React Hooks for state management and side effects in functional components.",
  },
  {
    title: "TypeScript for Beginners",
    url: "https://example.com/typescript",
    description:
      "Get started with TypeScript and learn how to add static typing to your JavaScript projects.",
  },
  {
    title: "CSS Grid Layout",
    url: "https://example.com/css-grid",
    description:
      "Master CSS Grid Layout to create complex web layouts with ease and flexibility.",
  },
  {
    title: "Node.js API Development",
    url: "https://example.com/nodejs",
    description:
      "Build robust APIs with Node.js, Express, and MongoDB for your web applications.",
  },
  {
    title: "Python Data Science",
    url: "https://example.com/python",
    description:
      "Explore data science with Python using libraries like NumPy, Pandas, and Matplotlib.",
  },
  {
    title: "GraphQL vs REST",
    url: "https://example.com/graphql",
    description:
      "Compare GraphQL and REST API architectures and learn when to use each approach.",
  },
  {
    title: "Docker Containers",
    url: "https://example.com/docker",
    description:
      "Learn how to containerize your applications with Docker for consistent deployment.",
  },
  {
    title: "AWS Cloud Services",
    url: "https://example.com/aws",
    description:
      "An overview of Amazon Web Services and how to leverage cloud computing for your projects.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Master Git for version control and collaboration in software development projects.",
  },
  {
    title: "UI/UX Design Principles",
    url: "https://example.com/ui-ux",
    description:
      "Learn the principles of user interface and user experience design for creating better products.",
  },
];
...
function App() {
  ...
  const [matchType, setMatchType] = useState<"contains" | "fuzzySearch">(
    "contains"
  );
  ...
  return (
    <div className="search-container">
      <a
        href="https://github.com/RockingThor/useSearch"
        target="_blank"
      ...
      <div className={`search-section ${hasResults ? "has-results" : ""}`}>
        ...
        <form onSubmit={handleSearch} className="search-form">
          ...
          <div className="search-buttons">
            ...
            <a
              href="https://me.rohitnandi.com/"
              target="_blank"
              rel="noopener noreferrer"
              className="search-button hire-me-button"
            >
              Hire Me
            </a>
          </div>
